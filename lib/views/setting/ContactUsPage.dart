...
class ContactUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('聯絡我們', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
        leading: IconButton(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: () => _launchUrl(_officialWebsiteUrl),
                child: Container(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.email_outlined, size: 40, color: Colors.red.shade300),
                      const SizedBox(width: 10),
                      const Text('tkuusrcare@gmail.com', style: TextStyle(fontSize: 22)),
                    ],
                  ),
                ),
              ),
